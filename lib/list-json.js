...
module.exports.getList = function(options , inThis , inHexo) {
    ...
    //--------------------------------------------
    if(inHexo && inHexo.locals && inHexo.locals.cache && inHexo.locals.cache.posts.length && inHexo.locals.cache.posts.data[0].popularPost_tmp_gaData){
